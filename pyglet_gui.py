...
win_a = pyglet.window.Window(540, 500, caption="Widget Example", visible=False)
config1 = win_a.config
context1 = win_a.context
context2 = config1.create_context(context1)
win_b = pyglet.window.Window(750, 700, context=context2)
...
frame = pyglet.gui.Frame(win_a, order=4)
