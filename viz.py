...
class Application:
    ...
    def __init__(self, robot_widget, urdf_model):
        ...
        self.button = glooey.Button("Click here!")
        self.label = glooey.EditableLabel("10")
        self.button.push_handlers(on_click=lambda w: self.pressed(w))
        self.buttonb = glooey.Button("Click here!")
        ...
        self.button2 = glooey.Button("Click here!")
        self.button2.push_handlers(on_click=lambda w: self.pressed2(w))
        self.button2b = glooey.Button("Click here!")
